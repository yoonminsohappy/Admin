<template>
  <section class="product-basic-info-component">
    ...
    <article>
      <div class="sub-title"><span>판매여부</span></div>
    ...
    <article>
      <div class="sub-title"><span>진열여부</span></div>
      <div class="sub-main-col">
        <div class="radio">
          <label>
            <input
    ...
    <article>
      <div class="sub-title"><span>카테고리</span><em>*</em></div>
      <div class="sub-main">
        <div class="category-container">
          <div class="category-header"><span>1차 카테고리</span></div>
      ...
      <div class="sub-main-col">
        <div class="radio">
          ...
          <label v-on:click="origin_self_inputer">
            <input type="radio" name="info" /><span>직접입력</span>
          </label>
        </div>
    ...
    <article>
      <div class="sub-title"><span>한줄 상품 설명</span></div>
      <div class="sub-main">
        <input
          class="full-size-input"
